...
function render(string $path, array $var = []){
 ...
 function addUser($nom,$login,$mdp,$role,$my_file)
 {
     $my_file.=".json";
     
     $login= checkemail($login) ? $login : $login."@ioc.com";

     if (file_exists($my_file)) {
        $current_data = file_get_contents($my_file);
        ...
        if (file_put_contents($my_file, $final_data)) {
            return true;
        }else{
            return false;
        }
 ...
 function getUsers($my_file)
 {
     $my_file.=".json";
    

     $json_string = file_get_contents($my_file);
     $parsed_json = json_decode($json_string, true);

     return $parsed_json;
 }

 function login($login,$mdp,$my_file)
 {
    $my_file.=".json";
